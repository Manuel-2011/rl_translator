...
best_checkpoint_name = "models/sft_base_qwen4_best"
min_loss = float("inf")
...
# Save the model
model.save_pretrained("models/sft_base_qwen2")
logger.info(f"Model saved to models/sft_base_qwen2")
